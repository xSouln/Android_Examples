...
class AccelerometerBuffer(var sizeMask: Int = 0x3ff) {
    var points: Array<AccelerometerValue> = Array(sizeMask + 1){ AccelerometerValue(0,0,0) }
    var totalIndex = 0
    var handlerIndex = 0

    fun put(value: AccelerometerValue){
